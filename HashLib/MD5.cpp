...
namespace {
    ...
    template<> struct S< 0, 0 > {
        static const uint32 value = 7;
    };
    template<> struct S< 0, 1 > {
        static const uint32 value = 12;
    };
    template<> struct S< 0, 2 > {
        static const uint32 value = 17;
    };
    template<> struct S< 0, 3 > {
        static const uint32 value = 22;
    };
    template<> struct S< 1, 0 > {
        static const uint32 value = 5;
    };
    template<> struct S< 1, 1 > {
        static const uint32 value = 9;
    };
    template<> struct S< 1, 2 > {
        static const uint32 value = 14;
    };
    template<> struct S< 1, 3 > {
        static const uint32 value = 20;
    };
    template<> struct S< 2, 0 > {
        static const uint32 value = 4;
    };
    template<> struct S< 2, 1 > {
        static const uint32 value = 11;
    };
    template<> struct S< 2, 2 > {
        static const uint32 value = 16;
    };
    template<> struct S< 2, 3 > {
        static const uint32 value = 23;
    };
    template<> struct S< 3, 0 > {
        static const uint32 value = 6;
    };
    template<> struct S< 3, 1 > {
        static const uint32 value = 10;
    };
    template<> struct S< 3, 2 > {
        static const uint32 value = 15;
    };
    template<> struct S< 3, 3 > {
        static const uint32 value = 21;
    };
...
// Free implementation of the MD5 hash algorithm, created 1991.
// MD5.CPP - RSA Data Security, Inc., MD5 message-digest algorithm
// Copyright (C) 1991-92, RSA Data Security, Inc. All rights reserved.
//
