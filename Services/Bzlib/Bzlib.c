...
void BZ2_bz__AssertH__fail ( int errcode ) {
    ...
    if (errcode == 1007) {
        fprintf(stderr,
                ...
                "\n"
                "Experience suggests that a common cause of 1007\n"
                ...
                "\n"
                "* If the error can be repeatably reproduced, likely a bug in bzip2\n"
                "* If the error cannot be reproduced, and/or happens at different\n"
                "  points in compression, you may have a flaky memory system.\n"
                "  Try a memory-test program.  Such as from Memtest86.com\n"
                "\n"
               );
    }
    exit(3);
