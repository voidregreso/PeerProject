...
/*
   ...
   In the case where there is not enough room, uncompress() will fill the
   output buffer with the uncompressed data up to that point.
*/
...
/*
   ...
   stream.  Alternatively, gzerror can be used before gzclose to detect this case.
