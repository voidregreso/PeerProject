...
// people share the same computer and somebody left WinRAR copy with entered password.
// So we decided to obfuscate the password to make it more difficult to find it in dump.
