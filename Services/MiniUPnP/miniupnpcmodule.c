...
static PyMemberDef UPnP_members[] = {
    ...
    },
    {
        ...
        "UPNP_LOCAL_PORT_ANY(0) system assign a source port, "
        "any other value will be attempted as the source port"
    },
...
static int UPnP_init(UPnPObject *self, PyObject *args, PyObject *kwds) {
    ...
    static char *kwlist[] = {
        "multicastif", "minissdpdsocket", "discoverdelay", "localport", NULL
    };
...
/* AddAnyPortMapping(externalPort, protocol, internalHost, internalPort, desc, remoteHost)
 * protocol is 'UDP' or 'TCP' */
static PyObject *
