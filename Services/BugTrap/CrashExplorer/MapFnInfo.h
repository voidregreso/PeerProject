...
public:
     ...
     */
    const std::string &GetDecoratedFunctionName() const {
     ...
     */
    virtual PVOID GetAddress() const {
        return m_ptrAddress;
    }
    /**
    ...
    virtual std::string GetName() const {
        return GetUndecoratedFunctionName();
    }
