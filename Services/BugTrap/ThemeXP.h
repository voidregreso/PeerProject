...
private:
    ...
    static HTHEME WINAPI OpenThemeDataFail(HWND hwnd, LPCWSTR pszClassList) {
        return NULL;
    }

    typedef HRESULT (WINAPI *PFNCLOSETHEMEDATA)(HTHEME hTheme);
    static HRESULT WINAPI CloseThemeDataFail(HTHEME hTheme) {
        return E_FAIL;
    }
    ...
    static HRESULT WINAPI DrawThemeBackgroundFail(HTHEME hTheme, HDC hdc, int iPartId, int iStateId, const RECT *pRect, const RECT *pClipRect) {
        return E_FAIL;
    }
    ...
    static HRESULT WINAPI DrawThemeTextFail(HTHEME hTheme, HDC hdc, int iPartId, int iStateId, LPCWSTR pszText, int iCharCount, DWORD dwTextFlags, DWORD dwTextFlags2, const RECT *pRect) {
        return E_FAIL;
    }
    ...
    static HRESULT WINAPI GetThemeBackgroundContentRectFail(HTHEME hTheme, HDC hdc, int iPartId, int iStateId, const RECT *pBoundingRect, RECT *pContentRect) {
        return E_FAIL;
    }
    ...
    static HRESULT WINAPI GetThemeBackgroundExtentFail(HTHEME hTheme, HDC hdc, int iPartId, int iStateId, const RECT *pContentRect, RECT *pExtentRect) {
        return E_FAIL;
    }
    ...
    static HRESULT WINAPI GetThemePartSizeFail(HTHEME hTheme, HDC hdc, int iPartId, int iStateId, RECT *pRect, enum THEMESIZE eSize, SIZE *psz) {
        return E_FAIL;
    }
    ...
    static HRESULT WINAPI GetThemeTextExtentFail(HTHEME hTheme, HDC hdc, int iPartId, int iStateId, LPCWSTR pszText, int iCharCount, DWORD dwTextFlags, const RECT *pBoundingRect, RECT *pExtentRect) {
        return E_FAIL;
    }

    typedef HRESULT (WINAPI *PFNGETTHEMETEXTMETRICS)(HTHEME hTheme, HDC hdc, int iPartId, int iStateId, TEXTMETRIC *ptm);
    static HRESULT WINAPI GetThemeTextMetricsFail(HTHEME hTheme, HDC hdc, int iPartId, int iStateId, TEXTMETRIC *ptm) {
        return E_FAIL;
    }
    ...
    static HRESULT WINAPI GetThemeBackgroundRegionFail(HTHEME hTheme, HDC hdc, int iPartId, int iStateId, const RECT *pRect, HRGN *pRegion) {
        return E_FAIL;
    }
    ...
    static HRESULT WINAPI HitTestThemeBackgroundFail(HTHEME hTheme, HDC hdc, int iPartId, int iStateId, DWORD dwOptions, const RECT *pRect, HRGN hrgn, POINT ptTest, WORD *pwHitTestCode) {
        return E_FAIL;
    }
    ...
    static HRESULT WINAPI DrawThemeEdgeFail(HTHEME hTheme, HDC hdc, int iPartId, int iStateId, const RECT *pDestRect, UINT uEdge, UINT uFlags, RECT *pContentRect) {
        return E_FAIL;
    }
    ...
    static HRESULT WINAPI DrawThemeIconFail(HTHEME hTheme, HDC hdc, int iPartId, int iStateId, const RECT *pRect, HIMAGELIST himl, int iImageIndex) {
        return E_FAIL;
    }

    typedef BOOL (WINAPI *PFNISTHEMEPARTDEFINED)(HTHEME hTheme, int iPartId, int iStateId);
    static BOOL WINAPI IsThemePartDefinedFail(HTHEME hTheme, int iPartId, int iStateId) {
        return FALSE;
    }

    typedef BOOL (WINAPI *PFNISTHEMEBACKGROUNDPARTIALLYTRANSPARENT)(HTHEME hTheme, int iPartId, int iStateId);
    static BOOL WINAPI IsThemeBackgroundPartiallyTransparentFail(HTHEME hTheme, int iPartId, int iStateId) {
        return FALSE;
    }

    typedef HRESULT (WINAPI *PFNGETTHEMECOLOR)(HTHEME hTheme, int iPartId, int iStateId, int iPropId, COLORREF *pColor);
    static HRESULT WINAPI GetThemeColorFail(HTHEME hTheme, int iPartId, int iStateId, int iPropId, COLORREF *pColor) {
        return E_FAIL;
    }

    typedef HRESULT (WINAPI *PFNGETTHEMEMETRIC)(HTHEME hTheme, HDC hdc, int iPartId, int iStateId, int iPropId, int *piVal);
    static HRESULT WINAPI GetThemeMetricFail(HTHEME hTheme, HDC hdc, int iPartId, int iStateId, int iPropId, int *piVal) {
        return E_FAIL;
    }
    ...
    static HRESULT WINAPI GetThemeStringFail(HTHEME hTheme, int iPartId, int iStateId, int iPropId, LPWSTR pszBuff, int cchMaxBuffChars) {
        return E_FAIL;
    }

    typedef HRESULT (WINAPI *PFNGETTHEMEBOOL)(HTHEME hTheme, int iPartId, int iStateId, int iPropId, BOOL *pfVal);
    static HRESULT WINAPI GetThemeBoolFail(HTHEME hTheme, int iPartId, int iStateId, int iPropId, BOOL *pfVal) {
        return E_FAIL;
    }

    typedef HRESULT (WINAPI *PFNGETTHEMEINT)(HTHEME hTheme, int iPartId, int iStateId, int iPropId, int *piVal);
    static HRESULT WINAPI GetThemeIntFail(HTHEME hTheme, int iPartId, int iStateId, int iPropId, int *piVal) {
        return E_FAIL;
    }

    typedef HRESULT (WINAPI *PFNGETTHEMEENUMVALUE)(HTHEME hTheme, int iPartId, int iStateId, int iPropId, int *piVal);
    static HRESULT WINAPI GetThemeEnumValueFail(HTHEME hTheme, int iPartId, int iStateId, int iPropId, int *piVal) {
        return E_FAIL;
    }

    typedef HRESULT (WINAPI *PFNGETTHEMEPOSITION)(HTHEME hTheme, int iPartId, int iStateId, int iPropId, POINT *pPoint);
    static HRESULT WINAPI GetThemePositionFail(HTHEME hTheme, int iPartId, int iStateId, int iPropId, POINT *pPoint) {
        return E_FAIL;
    }

    typedef HRESULT (WINAPI *PFNGETTHEMEFONT)(HTHEME hTheme, HDC hdc, int iPartId, int iStateId, int iPropId, LOGFONT *pFont);
    static HRESULT WINAPI GetThemeFontFail(HTHEME hTheme, HDC hdc, int iPartId, int iStateId, int iPropId, LOGFONT *pFont) {
        return E_FAIL;
    }

    typedef HRESULT (WINAPI *PFNGETTHEMERECT)(HTHEME hTheme, int iPartId, int iStateId, int iPropId, RECT *pRect);
    static HRESULT WINAPI GetThemeRectFail(HTHEME hTheme, int iPartId, int iStateId, int iPropId, RECT *pRect) {
        return E_FAIL;
    }
    ...
    static HRESULT WINAPI GetThemeMarginsFail(HTHEME hTheme, HDC hdc, int iPartId, int iStateId, int iPropId, RECT *prc, MARGINS *pMargins) {
        return E_FAIL;
    }

    typedef HRESULT (WINAPI *PFNGETTHEMEINTLIST)(HTHEME hTheme, int iPartId, int iStateId, int iPropId, INTLIST *pIntList);
    static HRESULT WINAPI GetThemeIntListFail(HTHEME hTheme, int iPartId, int iStateId, int iPropId, INTLIST *pIntList) {
        return E_FAIL;
    }
    ...
    static HRESULT WINAPI GetThemePropertyOriginFail(HTHEME hTheme, int iPartId, int iStateId, int iPropId, enum PROPERTYORIGIN *pOrigin) {
        return E_FAIL;
    }

    typedef HRESULT (WINAPI *PFNSETWINDOWTHEME)(HWND hwnd, LPCWSTR pszSubAppName, LPCWSTR pszSubIdList);
    static HRESULT WINAPI SetWindowThemeFail(HWND hwnd, LPCWSTR pszSubAppName, LPCWSTR pszSubIdList) {
        return E_FAIL;
    }
    ...
    static HRESULT WINAPI GetThemeFilenameFail(HTHEME hTheme, int iPartId, int iStateId, int iPropId, LPWSTR pszThemeFileName, int cchMaxBuffChars) {
        return E_FAIL;
    }

    typedef COLORREF (WINAPI *PFNGETTHEMESYSCOLOR)(HTHEME hTheme, int iColorId);
    static COLORREF WINAPI GetThemeSysColorFail(HTHEME hTheme, int iColorId) {
        return RGB(255, 255, 255);
    }

    typedef HBRUSH (WINAPI *PFNGETTHEMESYSCOLORBRUSH)(HTHEME hTheme, int iColorId);
    static HBRUSH WINAPI GetThemeSysColorBrushFail(HTHEME hTheme, int iColorId) {
        return NULL;
    }

    typedef BOOL (WINAPI *PFNGETTHEMESYSBOOL)(HTHEME hTheme, int iBoolId);
    static BOOL WINAPI GetThemeSysBoolFail(HTHEME hTheme, int iBoolId) {
        return FALSE;
    }

    typedef int (WINAPI *PFNGETTHEMESYSSIZE)(HTHEME hTheme, int iSizeId);
    static int WINAPI GetThemeSysSizeFail(HTHEME hTheme, int iSizeId) {
        return 0;
    }

    typedef HRESULT (WINAPI *PFNGETTHEMESYSFONT)(HTHEME hTheme, int iFontId, LOGFONT *plf);
    static HRESULT WINAPI GetThemeSysFontFail(HTHEME hTheme, int iFontId, LOGFONT *plf) {
        return E_FAIL;
    }

    typedef HRESULT (WINAPI *PFNGETTHEMESYSSTRING)(HTHEME hTheme, int iStringId, LPWSTR pszStringBuff, int cchMaxStringChars);
    static HRESULT WINAPI GetThemeSysStringFail(HTHEME hTheme, int iStringId, LPWSTR pszStringBuff, int cchMaxStringChars) {
        return E_FAIL;
    }

    typedef HRESULT (WINAPI *PFNGETTHEMESYSINT)(HTHEME hTheme, int iIntId, int *piValue);
    static HRESULT WINAPI GetThemeSysIntFail(HTHEME hTheme, int iIntId, int *piValue) {
        return E_FAIL;
    }

    typedef BOOL (WINAPI *PFNISTHEMEACTIVE)();
    static BOOL WINAPI IsThemeActiveFail() {
        return FALSE;
    }

    typedef BOOL(WINAPI *PFNISAPPTHEMED)();
    static BOOL WINAPI IsAppThemedFail() {
        return FALSE;
    }

    typedef HTHEME (WINAPI *PFNGETWINDOWTHEME)(HWND hwnd);
    static HTHEME WINAPI GetWindowThemeFail(HWND hwnd) {
        return NULL;
    }

    typedef HRESULT (WINAPI *PFNENABLETHEMEDIALOGTEXTURE)(HWND hwnd, DWORD dwFlags);
    static HRESULT WINAPI EnableThemeDialogTextureFail(HWND hwnd, DWORD dwFlags) {
        return E_FAIL;
    }

    typedef BOOL (WINAPI *PFNISTHEMEDIALOGTEXTUREENABLED)(HWND hwnd);
    static BOOL WINAPI IsThemeDialogTextureEnabledFail(HWND hwnd) {
        return FALSE;
    }

    typedef DWORD (WINAPI *PFNGETTHEMEAPPPROPERTIES)();
    static DWORD WINAPI GetThemeAppPropertiesFail() {
        return 0;
    }
    ...
    static HRESULT WINAPI GetCurrentThemeNameFail(LPWSTR pszThemeFileName, int cchMaxNameChars, LPWSTR pszColorBuff, int cchMaxColorChars, LPWSTR pszSizeBuff, int cchMaxSizeChars) {
        return E_FAIL;
    }
    ...
    static HRESULT WINAPI GetThemeDocumentationPropertyFail(LPCWSTR pszThemeName, LPCWSTR pszPropertyName, LPWSTR pszValueBuff, int cchMaxValChars) {
        return E_FAIL;
    }

    typedef HRESULT (WINAPI *PFNDRAWTHEMEPARENTBACKGROUND)(HWND hwnd, HDC hdc, RECT *prc);
    static HRESULT WINAPI DrawThemeParentBackgroundFail(HWND hwnd, HDC hdc, RECT *prc) {
        return E_FAIL;
    }

    typedef HRESULT (WINAPI *PFNENABLETHEMING)(BOOL fEnable);
    static HRESULT WINAPI EnableThemingFail(BOOL fEnable) {
        return E_FAIL;
    }
