            ...
            if (pnmv->uNewState & LVIS_SELECTED) {
                ...
                if (g_pEnumProc->GetModuleFirst((DWORD)pnmv->lParam, module)) {
                    ...
                    do {
                        ...
                        TCHAR szTempBuf[32];
#if defined _WIN64
                        _stprintf_s(szTempBuf, countof(szTempBuf), _T("%016X"), (DWORD)(DWORD_PTR)module.m_pLoadBase);
#elif defined _WIN32
                        _stprintf_s(szTempBuf, countof(szTempBuf), _T("%08X"), (DWORD)(DWORD_PTR)module.m_pLoadBase);
#endif
