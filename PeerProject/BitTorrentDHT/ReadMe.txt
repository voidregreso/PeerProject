...
It is a good idea to use that when e.g. restoring your routing table from disk.
...
combined with the new one -- you will only receive a completion indication once.
...
This should compute a reasonably strong cryptographic hash of the passed values.
It should map cleanly to your favorite crypto toolkit's MD5 or SHA-1 function.
