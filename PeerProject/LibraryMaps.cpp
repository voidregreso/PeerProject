...
//////////////////////////////////////////////////////////////////////
// CLibraryMaps lookup file by URN (Hash)
...
CLibraryFile *CLibraryMaps::LookupFileByHash(const CPeerProjectFile *pFilter, BOOL bSharedOnly, BOOL bAvailableOnly) const {
    CQuickLock oLock( Library.m_pSection );
