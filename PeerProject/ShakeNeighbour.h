...
protected:
    BOOL	m_bCanDeflate;			// PeerProject Settings allow us to send and receive compressed data
    ...
    //    Content-Type: application/x-peerproject
    ...
    //    Accept: application/x-peerproject
...
protected:
    ...
    void SendMinimalHeaders();		// Tell the remote computer we are PeerProject, and try to setup Gnutella2 communications
