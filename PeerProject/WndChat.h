...
public:
    ...
    inline CChatMessage &operator=(const CChatMessage &pMsg) {
        m_bType = pMsg.m_bType;
        m_sFrom = pMsg.m_sFrom;
        m_sMessage = pMsg.m_sMessage;
        m_hBitmap = pMsg.m_hBitmap;
        return *this;
    }
...
public:
    ...
    inline CChatUser &operator=(const CChatUser &pUser) {
        m_bType = pUser.m_bType;
        m_sNick = pUser.m_sNick;
        m_sDescription = pUser.m_sDescription;
