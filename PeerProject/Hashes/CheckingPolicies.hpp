...
namespace Hashes {
    namespace Policies {
        ...
        public:
            bool check() const {
                return CheckHelper< wordCount >()( begin() );
            }
        };
        ...
        //! It checks the current value against the global & local blacklist.
        //! The local blacklist is local to a particular object
        //! and not copied when the object is copied.\n
        //! Rationale:\n
        ...
        public:
            ...
            std::vector< AlignedStorage > &blacklist() {
                return m_blacklist;
            }
