...
{
    [Serializable]
    [XmlType(AnonymousType = true, Namespace = "http://schemas.peerproject.org/Skin.xsd")]
    [XmlRoot(Namespace = "http://www.PeerProject.com/schemas/Skin.xsd", IsNullable = false)]
    public class skin
    {
        [XmlElement("manifest")]
    ...
    [Serializable]
    [XmlType(AnonymousType = true, Namespace = "http://www.PeerProject.com/schemas/Skin.xsd")]
