...
namespace Updater.Common
{
    public abstract partial class AbstractGenericPageView<T> : UserControl, IPageView where T : class, INamedElement
    {
        ...
        static readonly string envelopeFormat = "<skin xmlns=\"http://www.PeerProject.com/schemas/Skin.xsd\" version=\"1.0\">\r\n" +
                                                "<{0}>\r\n{1}\r\n" +
                                                "</{0}>\r\n" +
                                                "</skin>";
        ...
        string GetXml(T element)
        {
            ...
            if (XmlSerializerBase<T>.Write(element, out stream))
            {
                ...
                try
                {
                    ...
                    xml = xml.Replace(" xmlns=\"http://www.PeerProject.com/schemas/Skin.xsd\"", String.Empty);
        ...
        public bool IsReadyForExport
        {
            get
            {
                return updatesList != null && newEnList != null && oldEnList != null;
            }
        }
        ...
        public Font UpdatePaneFont
        {
            get
            {
                return richUpdate.Font;
            }
            set
            {
                richUpdate.Font = value;
            }
        }
