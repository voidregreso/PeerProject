...
LSTATUS CreateSkinKeys() {
    ...
    rtn = CreateHKCRKey( L"PeerProject.SkinFile", L"", L"PeerProject Skin File" );
    if ( rtn != ERROR_SUCCESS ) return rtn;
    rtn = CreateHKCRKey( L"SOFTWARE\\Classes\\PeerProject.SkinFile\\DefaultIcon", L"", imagpath );
    if ( rtn != ERROR_SUCCESS ) return rtn;
    rtn = CreateHKCRKey( L"SOFTWARE\\Classes\\PeerProject.SkinFile\\shell", L"", L"open" );
    if ( rtn != ERROR_SUCCESS ) return rtn;
    rtn = CreateHKCRKey( L"SOFTWARE\\Classes\\PeerProject.SkinFile\\shell\\open\\command", L"", fullpath );
    if ( rtn != ERROR_SUCCESS ) return rtn;
    rtn = CreateHKCRKey( L"SOFTWARE\\Classes\\PeerProject.SkinFile\\shell\\skininstall", L"", L"Install PeerProject Skin" );
    if ( rtn != ERROR_SUCCESS ) return rtn;
    rtn = CreateHKCRKey( L"SOFTWARE\\Classes\\PeerProject.SkinFile\\shell\\skininstall\\command", L"", fullpath );
    if ( rtn != ERROR_SUCCESS ) return rtn;
...
LSTATUS DeleteSkinKeys() {
    ...
    DeleteHKCRKey( L"SOFTWARE\\Classes\\PeerProject.SkinFile\\shell\\open\\command", L"" );
    DeleteHKCRKey( L"SOFTWARE\\Classes\\PeerProject.SkinFile\\shell\\open", L"" );
    DeleteHKCRKey( L"SOFTWARE\\Classes\\PeerProject.SkinFile\\shell\\skininstall\\command", L"" );
    DeleteHKCRKey( L"SOFTWARE\\Classes\\PeerProject.SkinFile\\shell\\skininstall", L"" );
    DeleteHKCRKey( L"SOFTWARE\\Classes\\PeerProject.SkinFile\\shell", L"" );
    DeleteHKCRKey( L"SOFTWARE\\Classes\\PeerProject.SkinFile\\DefaultIcon", L"" );
    DeleteHKCRKey( L"SOFTWARE\\Classes\\PeerProject.SkinFile", L"" );
    return ERROR_SUCCESS;
}
