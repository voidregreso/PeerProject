...
namespace Schemas
{
    ...
    {
        [XmlElement("book")]
        public PeerProjectBook[] books;
        public static readonly string URI = @"http://www.limewire.com/schemas/book.xsd";

        public Books()
        {
            books = (PeerProjectBook[])Array.CreateInstance(typeof(PeerProjectBook), 1);
        }
    }

    [XmlType(Namespace = "http://www.limewire.com/schemas/book.xsd")]
    public class PeerProjectBook
    {
        public PeerProjectBook() {}
        ...
        public PeerProjectBook(FictionBook fb)
        {
