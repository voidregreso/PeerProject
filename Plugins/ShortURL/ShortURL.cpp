//
// ShortURL.cpp : Implementation of DLL Exports.
//
...
class CShortURLModule : public CAtlDllModuleT< CShortURLModule > {
public :
    DECLARE_LIBID(LIBID_ShortURLLib)
    DECLARE_REGISTRY_APPID_RESOURCEID(IDR_SHORTURL, "{0F99F34D-3377-4882-9251-E00D680C6C8a}")
};

CShortURLModule _AtlModule;
