...
// The CTextWindow class contained in this file represents a single image window
...
//////////////////////////////////////////////////////////////////////
// CTextWindow construction

CTextWindow::CTextWindow() {
    m_pPlugin		= NULL;		// Reference to the plugin that owns us
    m_pNext			= NULL;		// Next CTextWindow in the linked list of open windows
...
//////////////////////////////////////////////////////////////////////
// CTextWindow destruction

CTextWindow::~CTextWindow() {
    // Remove this CTextWindow object from the plugin's linked list of open windows
...
//////////////////////////////////////////////////////////////////////
// CTextWindow create the window

BOOL CTextWindow::Create(CTextViewerPlugin *pPlugin, LPCTSTR pszFile) {
    ...
    // Tell the GUI manager to create a new window called "TextViewerWindow".
    // We pass "this" as the IPluginWindowOwner, and store the IPluginWindow in m_pWindow.
    pUI->NewWindow( L"TextViewerWindow", this, &m_pWindow );
    ...
    m_pWindow->AddToolbar( L"TextViewerWnd", 0, NULL, NULL );
...
//////////////////////////////////////////////////////////////////////
// CTextWindow refresh the image

BOOL CTextWindow::Refresh() {
...
//////////////////////////////////////////////////////////////////////
// CTextWindow resize the window to handle the image

BOOL CTextWindow::ResizeWindow() {
    HWND hMDI = GetParent();
    RECT rcWnd, rcMDI;
    // Must have an image
...
//////////////////////////////////////////////////////////////////////
// CTextWindow rescale the image to fit in the window

BOOL CTextWindow::RescaleImage() {
    RECT rc;
    SIZE sz;
    // Must have an image
    if ( m_pImage.m_nHeight == 0 ) return FALSE;
...
//////////////////////////////////////////////////////////////////////
// CTextWindow IPluginWindowOwner message dispatch

HRESULT STDMETHODCALLTYPE CTextWindow::OnTranslate(MSG __RPC_FAR * /*pMessage*/) {
...
HRESULT STDMETHODCALLTYPE CTextWindow::OnMessage(UINT nMessage, WPARAM wParam, LPARAM lParam, LRESULT __RPC_FAR *plResult) {
...
//////////////////////////////////////////////////////////////////////
// CTextWindow message handlers

LRESULT CTextWindow::OnDestroy(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL &bHandled) {
    KillTimer( 2 );
    bHandled = FALSE;
    return 0;
}

LRESULT CTextWindow::OnContextMenu(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM lParam, BOOL & /*bHandled*/) {
    ...
    m_pWindow->ThrowMenu( L"TextViewer_Context", 0, &pt );
    return 0;
}

LRESULT CTextWindow::OnSize(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL &bHandled) {
...
LRESULT CTextWindow::OnPaint(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL & /*bHandled*/) {
...
LRESULT CTextWindow::OnKeyDown(UINT /*uMsg*/, WPARAM wParam, LPARAM /*lParam*/, BOOL & /*bHandled*/) {
...
LRESULT CTextWindow::OnLButtonDblClk(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL & /*bHandled*/) {
...
LRESULT CTextWindow::OnLButtonDown(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM lParam, BOOL & /*bHandled*/) {
...
LRESULT CTextWindow::OnLButtonUp(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL & /*bHandled*/) {
    // Finish dragging
    if ( m_bDrag ) {
        ReleaseCapture();
        m_bDrag = FALSE;
...
LRESULT CTextWindow::OnMouseMove(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM lParam, BOOL & /*bHandled*/) {
...
LRESULT CTextWindow::OnMouseWheel(UINT /*uMsg*/, WPARAM wParam, LPARAM /*lParam*/, BOOL & /*bHandled*/) {
    if ( m_hBitmap != NULL ) {
...
LRESULT CTextWindow::OnSetCursor(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM lParam, BOOL &bHandled) {
...
LRESULT CTextWindow::OnTimer(UINT /*uMsg*/, WPARAM wParam, LPARAM /*lParam*/, BOOL &bHandled) {
...
//////////////////////////////////////////////////////////////////////
// CTextWindow IPluginWindowOwner command implementation

HRESULT STDMETHODCALLTYPE CTextWindow::OnUpdate(UINT nCommandID, TRISTATE __RPC_FAR * /*pbVisible*/, TRISTATE __RPC_FAR * /*pbEnabled*/, TRISTATE __RPC_FAR *pbChecked) {
...
HRESULT STDMETHODCALLTYPE CTextWindow::OnCommand(UINT nCommandID) {
