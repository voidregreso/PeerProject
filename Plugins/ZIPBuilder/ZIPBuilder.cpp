//
// ZIPBuilder.cpp : Implementation of DLL Exports.
//
...
public :
    DECLARE_LIBID( LIBID_ZIPBuilderLib )
    DECLARE_REGISTRY_APPID_RESOURCEID( IDR_APP, "{C2AC3234-100D-4CC4-BCBB-ACF5F18D4854}" )
};
